...
from data import create_datasets, cycle 
from model import ModelConfig, Transformer, evaluate, print_samples


if __name__ == '__main__':

    # parse command line args
    parser = argparse.ArgumentParser(description="Train a protein transformer model based on GPT")
    ...
    for batch in cycle(train_loader):
        ...
        if step > 0 and step % 200 == 0:
            print_samples(10, args, train_dataset, model, test_dataset)
